...
<h4 style="text-align: center">Country Master</h4>
<form id="saveCountry" action="/saveCountry" method="post">
  <div style="margin: auto" class="form-group col-md-8">

    <div class="form-group row required">
      <div class="col-md-4">
        <label class="form-label control-label" >Country Name</label>
        <input type="text" class="form-control" id="inputCountry" name="inputCountry"  placeholder="Enter Country Name"/>
        <div id="alert"></div>
      </div>
...
<div style="margin: 8rem">
  <h4 style="text-align: center">All Country Details</h4>
  ...
  <table id="qualificationTable table" class="table table-striped table-bordered">
    ...
    <tbody>
    <c:forEach items="${countryList}" var="countryList" varStatus="counter">
      <tr>
        <td>${counter.count}</td>
        <td>${countryList.cname}</td>
        <td>
          <a href = "/editCountry/${countryList.cid}">Edit</a>
          |
          <a href = "/deleteCountry/${countryList.cid}">Delete</a>
        </td>
      </tr>
    </c:forEach>
    </tbody>
