...
<h4 style="text-align: center">Qualification Master</h4>
<form id="saveQualification" action="/saveQualification" method="post">
    <div style="margin: auto" class="form-group col-md-8">

            <div class="form-group row required">
                <div class="col-md-4">
                    <label class="form-label control-label" >Qualification Name</label>
                    <input type="text" class="form-control" id="inputQualification" name="inputQualification"  placeholder="Enter Qualification"/>
                    <div id="alert"></div>
                </div>
    ...
    <div style="margin: 8rem">
        <h4 style="text-align: center">All Qualification Details</h4>
        ...
        <table id="qualificationTable table" class="table table-striped table-bordered">
            ...
            <tbody>
                <c:forEach items="${qualificationList}" var="qual" varStatus="counter">
                    <tr>
                        <td>${counter.count}</td>
                        <td>${qual.qualName}</td>
                        <td>
                            <a href = "/editQualification/${qual.qualId}">Edit</a>
                            |
                            <a href = "deleteQualification/${qual.qualId}">Delete</a>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
